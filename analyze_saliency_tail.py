...
class SaliencyTailAnalyzer:
    ...
    def detect_dual_knees(self, sorted_values):
        ...
        try:
            ...
            x_range = np.arange(second_half_len) + second_half_start
            y_values = sorted_values[second_half_start:].cpu().numpy()
            valid_mask = np.isfinite(y_values)
